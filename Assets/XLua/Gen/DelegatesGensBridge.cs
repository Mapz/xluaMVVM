...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp24(UnityEngine.AsyncOperation p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp25(UnityEngine.RectTransform p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp26(UnityEngine.Font p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp27(bool p0, bool p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public char __Gen_Delegate_Imp28(string p0, int p1, char p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public float __Gen_Delegate_Imp29(UnityEngine.UI.ILayoutElement p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp30(System.IAsyncResult p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp32(object p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp33(object p0, UnityEngine.Vector3 p1, UnityEngine.Vector3 p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp34(object p0, int p1, out double p2, ref string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp35(object p0, int p1, out double p2, ref string p3, object p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp38(XLuaTest.StructTest p0, int p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp39(XLuaTest.StructTest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp40(XLuaTest.StructTest p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp41(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(ValueChangeDelegate))
			{
			    return new ValueChangeDelegate(__Gen_Delegate_Imp4);
			}
			...
			{
			    return new UnityEngine.AudioSettings.AudioConfigurationChangeHandler(__Gen_Delegate_Imp11);
			}
			...
			{
			    return new System.Action<UnityEngine.AsyncOperation>(__Gen_Delegate_Imp24);
			}
		
		    if (type == typeof(UnityEngine.RectTransform.ReapplyDrivenProperties))
			{
			    return new UnityEngine.RectTransform.ReapplyDrivenProperties(__Gen_Delegate_Imp25);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Font>))
			{
			    return new System.Action<UnityEngine.Font>(__Gen_Delegate_Imp26);
			}
		
		    if (type == typeof(System.Action<bool, bool, int>))
			{
			    return new System.Action<bool, bool, int>(__Gen_Delegate_Imp27);
			}
		
		    if (type == typeof(UnityEngine.UI.InputField.OnValidateInput))
			{
			    return new UnityEngine.UI.InputField.OnValidateInput(__Gen_Delegate_Imp28);
			}
		
		    if (type == typeof(System.Func<UnityEngine.UI.ILayoutElement, float>))
			{
			    return new System.Func<UnityEngine.UI.ILayoutElement, float>(__Gen_Delegate_Imp29);
			}
		
		    if (type == typeof(System.AsyncCallback))
			{
			    return new System.AsyncCallback(__Gen_Delegate_Imp30);
			}
