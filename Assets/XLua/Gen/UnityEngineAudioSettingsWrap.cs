        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AudioSettings gen_ret = new UnityEngine.AudioSettings();
        ...
        static int _m_GetSpatializerPluginNames_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string[] gen_ret = UnityEngine.AudioSettings.GetSpatializerPluginNames(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetSpatializerPluginName_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string gen_ret = UnityEngine.AudioSettings.GetSpatializerPluginName(  );
        ...
        static int _m_GetConfiguration_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.AudioConfiguration gen_ret = UnityEngine.AudioSettings.GetConfiguration(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.AudioConfiguration _config;translator.Get(L, 1, out _config);
                        ...
                        bool gen_ret = UnityEngine.AudioSettings.Reset( _config );
