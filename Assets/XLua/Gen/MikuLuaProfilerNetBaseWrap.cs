...
namespace XLua.CSObjectWrap
{
    ...
    public class MikuLuaProfilerNetBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MikuLuaProfiler.NetBase);
        ...
        {
            return LuaAPI.luaL_error(L, "MikuLuaProfiler.NetBase does not have a constructor!");
        }
