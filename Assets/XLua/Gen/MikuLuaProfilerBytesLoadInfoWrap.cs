...
namespace XLua.CSObjectWrap
{
    ...
    public class MikuLuaProfilerBytesLoadInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MikuLuaProfiler.BytesLoadInfo);
        ...
        static int _m_ReadByte(RealStatePtr L)
        {
		    try {
                ...
                MikuLuaProfiler.BytesLoadInfo gen_to_be_invoked = (MikuLuaProfiler.BytesLoadInfo)translator.FastGetCSObj(L, 1);
