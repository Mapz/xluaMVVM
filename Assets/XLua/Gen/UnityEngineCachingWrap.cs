        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.Caching gen_ret = new UnityEngine.Caching();
        ...
        static int _m_ClearCache_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        bool gen_ret = UnityEngine.Caching.ClearCache(  );
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)) 
                {
                    int _expiration = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Caching.ClearCache( _expiration );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Hash128 _hash;translator.Get(L, 2, out _hash);
                        ...
                        bool gen_ret = UnityEngine.Caching.ClearCachedVersion( _assetBundleName, _hash );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Hash128 _hash;translator.Get(L, 2, out _hash);
                        ...
                        bool gen_ret = UnityEngine.Caching.ClearOtherCachedVersions( _assetBundleName, _hash );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetBundleName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Caching.ClearAllCachedVersions( _assetBundleName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.CachedAssetBundle>(L, 1)) 
                {
                    UnityEngine.CachedAssetBundle _cachedBundle;translator.Get(L, 1, out _cachedBundle);
                        ...
                        bool gen_ret = UnityEngine.Caching.IsVersionCached( _cachedBundle );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Hash128>(L, 2)) 
                {
                    ...
                    UnityEngine.Hash128 _hash;translator.Get(L, 2, out _hash);
                        ...
                        bool gen_ret = UnityEngine.Caching.IsVersionCached( _url, _hash );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.CachedAssetBundle>(L, 1)) 
                {
                    UnityEngine.CachedAssetBundle _cachedBundle;translator.Get(L, 1, out _cachedBundle);
                        ...
                        bool gen_ret = UnityEngine.Caching.MarkAsUsed( _cachedBundle );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Hash128>(L, 2)) 
                {
                    ...
                    UnityEngine.Hash128 _hash;translator.Get(L, 2, out _hash);
                        ...
                        bool gen_ret = UnityEngine.Caching.MarkAsUsed( _url, _hash );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _cachePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Cache gen_ret = UnityEngine.Caching.AddCache( _cachePath );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _cacheIndex = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.Cache gen_ret = UnityEngine.Caching.GetCacheAt( _cacheIndex );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _cachePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Cache gen_ret = UnityEngine.Caching.GetCacheByPath( _cachePath );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Cache _cache;translator.Get(L, 1, out _cache);
                        ...
                        bool gen_ret = UnityEngine.Caching.RemoveCache( _cache );
                        LuaAPI.lua_pushboolean(L, gen_ret);
