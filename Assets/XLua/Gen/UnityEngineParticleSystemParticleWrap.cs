		    ...
		    try {
                ...
                
                {
                    UnityEngine.ParticleSystem _system = (UnityEngine.ParticleSystem)translator.GetObject(L, 2, typeof(UnityEngine.ParticleSystem));
                        ...
                        float gen_ret = gen_to_be_invoked.GetCurrentSize( _system );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.ParticleSystem _system = (UnityEngine.ParticleSystem)translator.GetObject(L, 2, typeof(UnityEngine.ParticleSystem));
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.GetCurrentSize3D( _system );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.ParticleSystem _system = (UnityEngine.ParticleSystem)translator.GetObject(L, 2, typeof(UnityEngine.ParticleSystem));
                        ...
                        UnityEngine.Color32 gen_ret = gen_to_be_invoked.GetCurrentColor( _system );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.ParticleSystem _system = (UnityEngine.ParticleSystem)translator.GetObject(L, 2, typeof(UnityEngine.ParticleSystem));
                        ...
                        int gen_ret = gen_to_be_invoked.GetMeshIndex( _system );
