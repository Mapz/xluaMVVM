        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.Color>(L, 2))
				{
					...
					UnityEngine.ParticleSystem.MinMaxGradient gen_ret = new UnityEngine.ParticleSystem.MinMaxGradient(_color);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.Gradient>(L, 2))
				{
					...
					UnityEngine.ParticleSystem.MinMaxGradient gen_ret = new UnityEngine.ParticleSystem.MinMaxGradient(_gradient);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<UnityEngine.Color>(L, 2) && translator.Assignable<UnityEngine.Color>(L, 3))
				{
					...
					UnityEngine.ParticleSystem.MinMaxGradient gen_ret = new UnityEngine.ParticleSystem.MinMaxGradient(_min, _max);
					translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _lerpFactor = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Color gen_ret = gen_to_be_invoked.Evaluate( _time, _lerpFactor );
                        translator.PushUnityEngineColor(L, gen_ret);
