		    ...
		    try {
                ...
                
                {
                    UnityEngine.ParticleSystemCustomData _stream;translator.Get(L, 2, out _stream);
                        ...
                        UnityEngine.ParticleSystemCustomDataMode gen_ret = gen_to_be_invoked.GetMode( _stream );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.ParticleSystemCustomData _stream;translator.Get(L, 2, out _stream);
                        ...
                        int gen_ret = gen_to_be_invoked.GetVectorComponentCount( _stream );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _component = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        UnityEngine.ParticleSystem.MinMaxCurve gen_ret = gen_to_be_invoked.GetVector( _stream, _component );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.ParticleSystemCustomData _stream;translator.Get(L, 2, out _stream);
                        ...
                        UnityEngine.ParticleSystem.MinMaxGradient gen_ret = gen_to_be_invoked.GetColor( _stream );
                        translator.Push(L, gen_ret);
