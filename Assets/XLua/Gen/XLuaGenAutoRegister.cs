...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Mapz.Core.Timer), MapzCoreTimerWrap.__Register);
        ...
        static void wrapInit8(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(xLuaMVVM.Assets.MVVM.Wrap.Text), xLuaMVVMAssetsMVVMWrapTextWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Core.BaseObject), CoreBaseObjectWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Core.Utils.Utils), CoreUtilsUtilsWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.Config), MapzConfigWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.GameEntry), MapzGameEntryWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.Core.GameMain), MapzCoreGameMainWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.Core.Resource.FileUtil), MapzCoreResourceFileUtilWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.Core.Lua.XLuaExtentions), MapzCoreLuaXLuaExtentionsWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.Core.Lua.Injection), MapzCoreLuaInjectionWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.Core.Component.LuaManager), MapzCoreComponentLuaManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Mapz.Core.Component.ResManager), MapzCoreComponentResManagerWrap.__Register);
