...
namespace XLua.CSObjectWrap
{
    ...
    public class MapzCoreLuaLuaClassBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Mapz.Core.Lua.LuaClassBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Mapz.Core.Lua.LuaClassBehaviour gen_ret = new Mapz.Core.Lua.LuaClassBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Mapz.Core.Lua.LuaClassBehaviour constructor!");
        ...
        static int _g_get_luaScriptPath(RealStatePtr L)
        {
		    try {
                ...
                Mapz.Core.Lua.LuaClassBehaviour gen_to_be_invoked = (Mapz.Core.Lua.LuaClassBehaviour)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                Mapz.Core.Lua.LuaClassBehaviour gen_to_be_invoked = (Mapz.Core.Lua.LuaClassBehaviour)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.injections = (Mapz.Core.Lua.Injection[])translator.GetObject(L, 2, typeof(Mapz.Core.Lua.Injection[]));
