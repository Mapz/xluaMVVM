        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					UnityEngine.ParticleSystem.MinMaxCurve gen_ret = new UnityEngine.ParticleSystem.MinMaxCurve(_constant);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<UnityEngine.AnimationCurve>(L, 3))
				{
					...
					UnityEngine.ParticleSystem.MinMaxCurve gen_ret = new UnityEngine.ParticleSystem.MinMaxCurve(_multiplier, _curve);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 4 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<UnityEngine.AnimationCurve>(L, 3) && translator.Assignable<UnityEngine.AnimationCurve>(L, 4))
				{
					...
					UnityEngine.ParticleSystem.MinMaxCurve gen_ret = new UnityEngine.ParticleSystem.MinMaxCurve(_multiplier, _min, _max);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					UnityEngine.ParticleSystem.MinMaxCurve gen_ret = new UnityEngine.ParticleSystem.MinMaxCurve(_min, _max);
					translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _lerpFactor = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        float gen_ret = gen_to_be_invoked.Evaluate( _time, _lerpFactor );
                        LuaAPI.lua_pushnumber(L, gen_ret);
