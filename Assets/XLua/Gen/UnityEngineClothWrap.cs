        ...
        static int _m_GetVirtualParticleIndices(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetVirtualParticleIndices( _indices );
        ...
        static int _m_SetVirtualParticleIndices(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetVirtualParticleIndices( _indices );
        ...
        static int _m_GetVirtualParticleWeights(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetVirtualParticleWeights( _weights );
