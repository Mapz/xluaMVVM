        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.UI.Dropdown.OptionData gen_ret = new UnityEngine.UI.Dropdown.OptionData();
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					UnityEngine.UI.Dropdown.OptionData gen_ret = new UnityEngine.UI.Dropdown.OptionData(_text);
					translator.Push(L, gen_ret);
				...
				{
					UnityEngine.Sprite _image = (UnityEngine.Sprite)translator.GetObject(L, 2, typeof(UnityEngine.Sprite));
					
					UnityEngine.UI.Dropdown.OptionData gen_ret = new UnityEngine.UI.Dropdown.OptionData(_image);
					translator.Push(L, gen_ret);
				...
				{
					string _text = LuaAPI.lua_tostring(L, 2);
					UnityEngine.Sprite _image = (UnityEngine.Sprite)translator.GetObject(L, 3, typeof(UnityEngine.Sprite));
					
					UnityEngine.UI.Dropdown.OptionData gen_ret = new UnityEngine.UI.Dropdown.OptionData(_text, _image);
					translator.Push(L, gen_ret);
