		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.ParticleSystem gen_ret = gen_to_be_invoked.GetSubEmitterSystem( _index );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.ParticleSystemSubEmitterType gen_ret = gen_to_be_invoked.GetSubEmitterType( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.ParticleSystemSubEmitterProperties gen_ret = gen_to_be_invoked.GetSubEmitterProperties( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        float gen_ret = gen_to_be_invoked.GetSubEmitterEmitProbability( _index );
